...
- ResNet (152 layers and introduction of residual blocks)
  - Defeats the vanishing gradient problem
...
- Think it keeps the close distances the same.
...
- Loss:
  - Wants to keep close distances. Close points faraway give high loss. 
...
- Then the output gate (h_t =than(Cell_t)*sigmoid(Weight_o[h_t-1,x_t]+bias_o))
