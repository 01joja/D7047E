...
save_path_PCA = os.path.join(save_path,'1e-6 PCA.png')
save_path_tSNE = os.path.join(save_path,'1e-6 t-SNE.png')
...
print("Load 1e-6 network")
with open('1e-6', 'rb') as handle:
