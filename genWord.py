...
def genWord(decoder, prime_str='A', predict_len=100, temperature=0.8, cuda=False):
    hidden = decoder.init_hidden(1)
    prime_str = prime_str.lower()
    prime_str = re.findall(r"\w+|[^\w\s]", prime_str)
...
# Parse command line arguments
    ...
    argparser.add_argument('-p', '--prime_str', type=str, default='the')
    ...
    del args.filename
    print(genWord(decoder, **vars(args)))